...
public class ChatClient {
    ...
    public void msg(String sendTo, String msgBody, String hash) throws IOException {
        String cmd = "msg " + sendTo + " " + msgBody + " " + hash + "\n";
    ...
    private void handleMessage(String[] tokensMsg) {
        ...
        String hash = tokensMsg[3];

        for(MessageListener listener : messageListeners) {
            listener.onMessage(login, msgBody, hash);
        }
    }
